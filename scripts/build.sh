...
link_pkg react node_modules/.pnpm/react@18.3.1/node_modules/react
...
"$TSC" -p tsconfig.json
mkdir -p lib/host/compressor/native
cp src/host/large-session.js lib/host/large-session.js
cp src/host/compressor/*.js src/host/compressor/*.d.ts lib/host/compressor/
cp src/host/compressor/native/*.node lib/host/compressor/native/
echo "=== Build complete ==="
